            ...
            <div className="mt-5">
              ...
              <Tabs defaultValue="comments" className="w-[400px]">
                <TabsList className="mb-5">
                  ...
                  <TabsTrigger value="hsitory">History</TabsTrigger>
                  <TabsTrigger value="comments">Comments</TabsTrigger>
                </TabsList>
                <TabsContent value="all">All Content</TabsContent>
                <TabsContent value="history">All Hsitory</TabsContent>

                <TabsContent value="comments">
                  <CreateCommentForm issueId={issueId} />
                  <div className="mt-8 space-y-6">
                    {comment.comments.map((item) => (
                      <CommentCard item={item} key={item}></CommentCard>
                    ))}
                  </div>
                </TabsContent>
              </Tabs>
                  ...
                  {issue.issueDetails?.assign.fullName ? (
                    <div className="flex items-center gap-3">
                      <Avatar className="h-8 w-8 text-xs">
                        <AvatarFallback>{issue.issueDetails?.assign.fullName[0]}</AvatarFallback>
                      </Avatar>
