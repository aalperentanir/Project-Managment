...
export const ChatBox = () => {
    ...
    useEffect(() => {
      console.log("Chat Data:", chat); // Debug için konsola yazdır
      if (chat.chat?.id) {
    ...
    <div className="sticky ">
      <div className="border rounded-lg">
        ...
        <div className="relative p-0">
            <Input value={message} onChange={handleMessageChange} placeholder="send message" className="py-7 border-t outline-none focus:outline-none focus:ring-0 rounded-none border-b-0 border-x-0"/>
